...
import datetime
import speech_recognition as sr #pip install SpeechRecognition (requires Net)
...
def screenshot():
    ...
    img.save("C:\\Users\\Mehul\\OneDrive\\Pictures\\Screenshots\\ss.png")
def cpu():
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'time' in query:
            ...
            wb.get(edgepath).open_new_tab(search+".com")
            ...
            speak("I'm going offline now, sir.")
            quit()
